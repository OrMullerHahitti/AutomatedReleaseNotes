...
from backend.app.models.models import Sprint, WorkItem, LLMResponse , SprintRequest
import logging
...
async def generate_release_notes(request: SprintRequest, generator: BasicGenerator = Depends(get_generator),
