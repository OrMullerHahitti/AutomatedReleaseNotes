...
class SummarizeGenerator(BaseGenerator):
    ...
    async def generate_release_notes(self,llm, work_items: List[WorkItem]) :
        ...
        return release_notes_before_structure
...
if __name__ == "__main__":
    ...
    async def testing_one_two(language):
        ...
        gen = SummarizeGenerator(language,system_instructions=system_insturctions.system_one,summarize_format=summarize_format.format_three)
